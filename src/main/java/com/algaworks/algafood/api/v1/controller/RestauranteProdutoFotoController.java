...
import com.algaworks.algafood.apiopenapi.controller.RestauranteProdutoFotoControllerOpenApi;
...
public class RestauranteProdutoFotoController implements RestauranteProdutoFotoControllerOpenApi {
	...
	public FotoProdutoModel atualizarFoto(@PathVariable Long restauranteId, 
		...
		var arquivoFoto = Path.of("C://Algafood//catalogo", nomeArquivo);
	...
	public ResponseEntity<?> servirFoto(@PathVariable Long restauranteId, 
		...
		try {
			...
			verificarCampatibilidadeMediaType(mediaTypeFoto, mediatypesAceitas);
	...
	private void verificarCampatibilidadeMediaType(MediaType mediaTypeFoto, 
