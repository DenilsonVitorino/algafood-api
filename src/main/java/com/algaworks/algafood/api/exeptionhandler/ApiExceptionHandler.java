package com.algaworks.algafood.api.exeptionhandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult, HttpHeaders headers,
	 ...
	 @ExceptionHandler(ValidacaoException.class)
		public ResponseEntity<Object> validacaoException(ValidacaoException ex, WebRequest request) {		    
		    return handleValidationInternal(ex, ex.getBindingResult(), new HttpHeaders(), 
		            HttpStatus.BAD_REQUEST, request);
		}
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		if (rootCause instanceof InvalidFormatException) {
			return handleEInvalidFormat((InvalidFormatException) rootCause, headers, status, request);
	...
	protected ResponseEntity<Object> handleEInvalidFormat(InvalidFormatException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
